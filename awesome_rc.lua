...
terminal = "urxvtc" --try setting this to "x-terminal-emulator" instead
editor = os.getenv("EDITOR") or "gvim" --try setting this to "editor" instead
...
for s = 1, screen.count() do
	...
	-- CUSTOM
		...
		--date
			...
			vicious.register(date_widget, vicious.widgets.date, "%m/%d|%I:%M:%S%P", 1)
		--cpu
		...
		--volume
			...
			--vicious.register(vol_widget, vicious.widgets.volume, "$2:$1%", 5, "Master")
...
clientkeys = awful.util.table.join(
	...
	awful.key({ modkey, "Shift"   }, "f",      awful.client.floating.toggle                     ), --modified
