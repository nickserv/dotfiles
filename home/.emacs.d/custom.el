(custom-set-variables
 ...
 '(org-agenda-files (quote ("~/Google Drive/Notes/Org/Todo.org")))
 ...
 '(package-selected-packages
   (quote
    (paredit tern smex bind-key flx counsel sane-term flycheck-pos-tip undo-tree gist restart-emacs magithub browse-at-remote leuven-theme super-save exec-path-from-shell yaml-mode scss-mode projectile markdown-mode magit flycheck emmet-mode)))
